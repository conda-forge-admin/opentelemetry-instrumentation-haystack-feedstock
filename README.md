...
pixi add opentelemetry-instrumentation-haystack
# for installing globally
pixi global install opentelemetry-instrumentation-haystack
```
...
It is possible to list all of the versions of `opentelemetry-instrumentation-haystack` available on your platform:
...
```
pixi search opentelemetry-instrumentation-haystack --channel conda-forge
```
